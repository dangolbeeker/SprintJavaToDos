package com.todos.javatodos.config;
...
{
    static final String CLIENT_ID = "scott-client";//we can configure
    static final String CLIENT_SECRET = "scott-secret";///we can configure
